...
<div class="max-w-6xl mx-auto mt-10">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.uploads') }}" class="mt-2 md:mt-0 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-sm p-4 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold">{{ $news->where('created_at', '>=', now()->startOfMonth())->count() }}</h3>
                    </div>
                    <div class="text-3xl opacity-80">
        ...
        @if($news->isEmpty())
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">No news articles found. Click "Add News" to create your first article.</p>
                    </div>
                </div>
            </div>
        @else
