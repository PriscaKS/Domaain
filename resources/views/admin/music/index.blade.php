        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.uploads') }}"
                    class="mt-2 md:mt-0 px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($music as $track)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500">{{ $track->created_at->format('M d, Y') }}
                                    </td>
                                    <td class="px-6 py-4 text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-4">
                                            <!-- Play in Modal -->
                                            <button
                                                onclick="openPlayer('{{ asset('storage/' . $track->file) }}', '{{ $track->title }}')"
