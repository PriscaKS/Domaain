...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        ...
        <p class="text-center text-gray-600 max-w-2xl mx-auto mb-12">Your generous contribution helps us continue our mission. Every donation, no matter the size, makes a difference in our community.</p>
        ...
        <div class="flex flex-col lg:flex-row rounded-xl overflow-hidden shadow-xl">
            ...
            <div class="w-full lg:w-[70%] bg-gray-50 p-6 md:p-10">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" id="donationAmount" name="donationAmount" placeholder="Enter donation amount" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="frequency" value="once" checked>
                                <span class="ml-2">One Time</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="frequency" value="monthly">
                                <span class="ml-2">Monthly</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="frequency" value="quarterly">
                                <span class="ml-2">Quarterly</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="frequency" value="yearly">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="fullName" id="fullName" placeholder="Full Name" required class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email" placeholder="Email Address" required class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="phone" id="phone" placeholder="Phone Number" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <select name="country" id="country" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-wrap gap-4 mb-4">
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="paymentMethod" value="card" checked>
                                <span class="ml-2">Credit Card</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="paymentMethod" value="paypal">
                                <span class="ml-2">PayPal</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-[var(--theme-color)]" name="paymentMethod" value="bank">
                        ...
                        <div id="cardPaymentMethod" class="payment-method-section space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="cardNumber" id="cardNumber" placeholder="Card Number" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="expiryMonth" id="expiryMonth" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="expiryYear" id="expiryYear" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="cvv" id="cvv" placeholder="CVV" maxlength="4" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]">
                                </div>
                            </div>
                        </div>
                        
                        <!-- PayPal Method (Hidden by default) -->
                        <div id="paypalPaymentMethod" class="payment-method-section hidden text-center p-6 border border-gray-200 rounded-md">
...
<div id="bankPaymentMethod" class="payment-method-section hidden p-6 border border-gray-200 rounded-md">
    ...
    <!-- Screenshot Upload -->
    <div class="mt-6">
        <label for="transactionScreenshot" class="block text-sm font-medium text-gray-700">Upload Transaction Screenshot:</label>
        <input type="file" id="transactionScreenshot" name="transactionScreenshot" accept="image/*" class="mt-1 block w-full text-sm text-gray-500 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" onchange="handleImageUpload(event)">
        <!-- Image Preview -->
        <div id="imagePreview" class="mt-4">
            <p class="text-sm text-gray-500">No image selected.</p>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="comment" id="comment" rows="3" placeholder="Leave a comment (optional)" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[var(--theme-color)] focus:border-[var(--theme-color)]"></textarea>
                    </div>
                    
                    <!-- Privacy Policy and Terms -->
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="terms" name="terms" type="checkbox" required class="focus:ring-[var(--theme-color)] h-4 w-4 text-[var(--theme-color)] border-gray-300 rounded">
                        </div>
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-gray-700">
                                <label for="terms" class="font-medium text-gray-700">I agree to the <a href="#" class="text-[var(--theme-color)] hover:underline">Terms of Service</a> and <a href="#" class="text-[var(--theme-color)] hover:underline">Privacy Policy</a></label>
                            </div>
                        </div>
                        
                        <!-- Submit Button -->
                        <div class="pt-2">
                            <button type="submit" class="w-full bg-[var(--theme-color)] hover:bg-[var(--custom-orange)] text-white font-bold py-3 px-6 rounded-md transition-colors duration-300 flex items-center justify-center">
                ...
                <div class="w-full lg:w-[30%] bg-gray-800 relative overflow-hidden">
                    <img src="/assets/images/donate/20944629.jpg" 
                    alt="Donation Impact" 
                    ...
                    <div class="relative z-10 p-6 md:p-10 flex flex-col justify-center h-full text-white">
                        ...
                        <p class="mb-6">Every donation helps us continue our mission and create positive change in our communities.</p>
...
LL
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            donationBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    donationBtns.forEach(b => b.classList.remove('bg-[var(--theme-color)]', 'text-white'));
            ...
            paymentMethods.forEach(method => {
                method.addEventListener('change', function() {
                    ...
                    document.getElementById(`${this.value}PaymentMethod`).classList.remove('hidden');
                });
            });
            ...
            document.getElementById('donationForm').addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    alert('Thank you for your donation! You would now be redirected to complete the payment.');
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            img.classList.add('mt-2', 'w-40', 'h-40', 'border', 'border-gray-300', 'rounded-md');
